...
from server.helper.helper import valid_user_id, token_is_admin, token_is_owner, get_user_by_token
...
def test_invalid_user_id():
    with pytest.raises(ValueError, match = 'User ID is invalid'):
        ...
        admin_userpermission_change(get_user_by_token(u_id), -1, 2)
...
def test_invalid_permission():
    with pytest.raises(ValueError, match = 'Permission ID is invalid'):
        ...
        admin_userpermission_change(get_user_by_token(u_id), user.u_id, -1)
...
def test_user_admin():
        ...
        admin_userpermission_change(get_user_by_token(admin1.u_id), user.u_id, 1)
        assert user.permission == 1
        
        # Admin changing permission of another admin
        admin_userpermission_change(get_user_by_token(admin1.u_id), admin2.u_id, 1)
        assert admin2.permission == 1
        
        # Admin changing permission of owner
        admin_userpermission_change(get_user_by_token(admin1.u_id), owner.u_id, 2)
...
def test_user_owner():
        ...
        admin_userpermission_change(get_user_by_token(owner1.u_id), user.u_id, 1)
        assert user.permission == 1
        
        # Owner changing permission of another admin
        admin_userpermission_change(get_user_by_token(owner1.u_id), admin.u_id, 1)
        assert admin.permission == 1
        
        # Owner changing permission of owner
        admin_userpermission_change(get_user_by_token(owner1.u_id), owner2.u_id, 2)
...
def test_user_permission_possible_permissions:
        ...
        admin_userpermission_change(get_user_by_token(owner1.u_id), owner.u_id, 2)
        
        # Changing admin to owner
        admin_userpermission_change(get_user_by_token(owner1.u_id), owner.u_id, 1)
        
        # Changing owner to member
        admin_userpermission_change(get_user_by_token(owner1.u_id), owner.u_id, 3)